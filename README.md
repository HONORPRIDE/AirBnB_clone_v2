...
the Console commands allow the user to create, update, and destroy objects, as well as manage file storage. Using a system of JSON serialization/deserialization, storage is persistent between sessions.


---

<center><h3>Repository Contents by Project AIRBNB-V1-THE CONSOLE && AIRBNB-V2-SQLALCHEMY-ORM  Task</h3> </center>
...
```
---
<center><h3>Repository Contents by Project HBNB-V2  Task</h3> </center>
| Tasks | Files | Description |
| ----- | ----- | ------ |
|TASK 0 | FORK   |For this project you will fork THE codebase: 
update the repository name to AirBnB_clone_v2
update the README.md with your information but don’t delete the initial authors|
|TASK 1 |TEST | How to test with MySQL?
...
It’s time to change your storage engine and use SQLAlchemy Update BaseModel: (models/base_model.py)
